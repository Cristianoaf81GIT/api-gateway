...
export class JogadoresService {
    ...
    async criarJogador(criarJodadorDto: CriarJogadorDto) {
        ...
        const categoria: Categoria = await lastValueFrom(
            this.clientAdminBackend.send('consultar-categorias', criarJodadorDto.categoria),
        ); 
    ...
    async atualizarJogador(
        ...
        const categoria: Categoria = await lastValueFrom(
            this.clientAdminBackend.send('consultar-categorias', atualizarJogadorDto.categoria),
        );
